...
bool Sha1::selfTest()
{
	...
	const uint8_t test1_md[] = { 0xA9, 0x99, 0x3E, 0x36, 0x47, 0x06, 0x81, 0x6A, 0xBA, 0x3E,
				  0x25, 0x71, 0x78, 0x50, 0xC2, 0x6C, 0x9C, 0xD0, 0xD8, 0x9D };
	const uint8_t test2[] = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq";
	const uint32_t test2_len = array_size(test2) - 1;
	const uint8_t test2_md[] = { 0x84, 0x98, 0x3E, 0x44, 0x1C, 0x3B, 0xD2, 0x6E, 0xBA, 0xAE,
				  0x4A, 0xA1, 0xF9, 0x51, 0x29, 0xE5, 0xE5, 0x46, 0x70, 0xF1 };
	const uint32_t test3_len = 640;
	const uint8_t test3_single[] = { '0', '1', '2', '3', '4', '5', '6', '7' };
	const uint32_t test3_single_len = array_size(test3_single);
	uint8_t test3[test3_len];
	uint32_t i;
	for (i = 0; i < test3_len / test3_single_len; ++i)
		memcpy(test3 + (i * test3_single_len), test3_single, test3_single_len);
	const uint8_t test3_md[] = { 0xDE, 0xA3, 0x56, 0xA2, 0xCD, 0xDD, 0x90, 0xC7, 0xA7, 0xEC,
